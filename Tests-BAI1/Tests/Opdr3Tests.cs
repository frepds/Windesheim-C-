...
namespace BAI
{
    ...
    public class Opdr3Tests
    {
        ...
        public void Opdr3_01_SizeOk(int lower, int upper, int count)
        {
            ...
            // Act
            stack = Aftekenopdracht1.Opdr3RandomNumbers(lower, upper, count);
        ...
        {
            // Act
            Stack<int> stack = Aftekenopdracht1.Opdr3RandomNumbers(100_000, 500_000, 400_001);  // Veel getallen, elk getal komt 1x voor
        }
    }
}
